...
1. Download a 32 bit version of Java
  * Download it from <a title="java download" href="http://java.com/en/download/index.jsp" target="_blank">here</a>
  * Save it wherever
...
4. Test out your Java installation
  * Visit the following <a title="test java" href="http://www.java.com/en/download/testjava.jsp" target="_blank">page</a> in your 32-bit Firefox and make sure you're in fact using 32 bit Java
